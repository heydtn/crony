defmodule Crony do
  ...
  def ready_up(_) do
    {from, _} = Application.get_env(:crony, :chrome_remote_debug_port_from) |> Integer.parse()
    {to, _} = Application.get_env(:crony, :chrome_remote_debug_port_to) |> Integer.parse()
    pool_size = Crony.BrowserPool.Chrome.pool() |> Enum.count()
  ...
  test "out of order connections" do
    ...
    conn_0 = Crony.connection()
    conn_1 = Crony.connection()
